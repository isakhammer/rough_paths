...
+ bx + c = 0$, where $a$, $b$, and $c$ are positive integers, produce accurate tables for $\sin(x)$  and $\cos(x)$, and lastly big tables describing the movement of the sun, the moon and the five known planets \cite{van2013history}.
